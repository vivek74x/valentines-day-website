const DATA = {
  ...
  thingsILove: [
    "You’re funny when you’re not even trying 😭",
    "Your voice > any song",
    "You understand my weird humor and actually laugh at my terrible jokes",
    "You make awkward moments feel easy",
    "Your hugs feel like home",
    "Your chaotic energy matches mine perfectly",
    "You make me want to be less of a gremlin (that’s true love)",
  ...
  galleries: {
    gallery2: [
      { caption: "Us, but make it forever.", img: "01.heic" },
      { caption: "Your smile is my favorite place.", img: "02.heic" },
      ...
      { caption: "When you laugh, the world listens.", img: "07.heic" },
      { caption: "Two hearts, one rhythm.", img: "08.JPG" },
      { caption: "Every frame feels like home.", img: "09.JPG" },
      { caption: "You, me, and a little bit of magic.", img: "10.JPG" },
      ...
      { caption: "The way we look at each other.", img: "14.heic" },
      { caption: "A pause button for this moment.", img: "15.heic" },
      { caption: "Sunsets and you.", img: "16.JPG" },
      { caption: "Forever starts right here.", img: "17.JPG" },
